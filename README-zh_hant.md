...
若此問題出現在所有文章中，可以嘗試更換字體以解決該問題，可以嘗試尋找其他中意的字體或同一字體的更新版本。
...
## Markdown 可以導出為 .pdf 嗎？

不能，因為在 Markdown 下渲染後的文本無法做到很好的分頁。將無法完全顯示的東西直接裁切可能會導致文字或圖片被截斷到兩頁，放到下一頁則可能會導致前一頁出現很大的空白，因此暫不考慮提供。

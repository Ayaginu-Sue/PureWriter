...
純純寫作是編輯器，而非閱讀器，請儘量避免使用純純寫作打開過長的文章。如果發現因過長的文章導致啟動緩慢，請徹底刪除外部導入的超大文章。
...
- 網絡等條件允許的話，也可以嘗試使用其他無流量限制的 WebDAV 服務，如 [Teracloud](https://teracloud.jp/)、[Box](https://www.box.com/)、[Yandex disk](https://disk.yandex.com/)、自行搭建的 WebDAV 等。
...
由於百度雲開放了相關接口，百度雲備份可能在 20.0 版本左右提供。
...
微雲、阿里雲盤、微盤等國內網盤通常是不開放的網盤，並不提供（或很少提供）第三方應用可使用的鏈接途徑，並且可能還存在許多其他原因（如限速等），因此純純寫作暫不會選擇國內的其他網盤。

...
- [纯纯写作 Q\&A](#纯纯写作-qa)
  ...
  - [Markdown 可以导出为 .pdf 吗？](#markdown-可以导出为-pdf-吗)
...
若此问题出现在所有文章中，可以尝试更换字体以解决该问题，如尝试寻找其他中意的字体或同一字体的更新版本；若出现此问题时使用的字体为系统字体，也可以尝试将系统字体设置为自定义字体。
...
## Markdown 可以导出为 .pdf 吗？

不能，因为在 Markdown 下渲染后的文本无法做到很好的分页。将无法完全显示的东西直接裁切可能会导致文字或图片被截断到两页，放到下一页则可能会导致前一页出现很大的空白，因此暂不考虑提供。
